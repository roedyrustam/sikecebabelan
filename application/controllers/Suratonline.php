...
class Suratonline extends CI_Controller
{
    ...
    public function ajukan()
    {
        ...
        $this->session->set_flashdata('success', '<div class="alert alert-success alert-dismissible"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><h5><i class="icon fas fa-check"></i> Selamat!</h5> Anda Berhasil Mengajukan Surat, silahkan  Salin /screenshot <b>ID</b> anda untuk melakukan pengecekan: <b> ' . $id . '</b></div>');
        redirect(base_url("suratonline"));
    }
}