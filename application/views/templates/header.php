...
<body>
    ...
    -->
            <div class="logo">
                <a href="http://sikece.id" class="simple-text logo-mini">
                    SI
                </a>
                <a href="http://sikece.id" class="simple-text logo-normal">
                    KeCe Babelan
                </a>
            </div>
                ...
                <ul class="nav">
                    ...
                    <li class="
                        ...
                        " id="formsExamples">
                            <ul class="nav">
                                <li class="
                                <?php if ($sub_title == 'Profil kecamatan') : ?>
                                    <?= 'active'; ?>
                                <?php endif; ?>
                                ">
                                    <a href="<?= base_url() ?>galery/profil_kecamatan">
                                        <span class="sidebar-mini">RF</span>
                                        <span class="sidebar-normal">Profil kecamatan</span>
                                    </a>
                                </li>
                                <li class="
                                <?php if ($sub_title == 'Struktur kecamatan') : ?>
                                    <?= 'active'; ?>
                                <?php endif; ?>
                                ">
                                    <a href="<?= base_url() ?>galery/s_kecamatan">
                                        <span class="sidebar-mini">EF</span>
                                        <span class="sidebar-normal">Struktur kecamatan</span>
                                    </a>
                                </li>
                                <li class="
                                ...
                                <li class="
                                <?php if ($sub_title == 'Struktur Pemuda kecamatan') : ?>
                                    <?= 'active'; ?>
                                <?php endif; ?>
                                ">
                                    <a href="<?= base_url() ?>galery/s_pemuda">
                                        <span class="sidebar-mini">W</span>
                                        <span class="sidebar-normal">Pemuda kecamatan</span>
                                    </a>
                                </li>
                                <li class="
