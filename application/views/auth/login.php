    ...
    <nav class="navbar navbar-primary navbar-transparent navbar-absolute">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href=" ../dashboard.html ">Sistem Informasi Manajemen Surat Menyurat Kecamatan
                    Babelan</a>
            </div>
                        ...
                        <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                            <form method="post" action="">
                                <div class="card card-login card-hidden">
                                    ...
                                    <br>
                                    <center>
                                        <p>Admin <a href='https://sikece.id/' title='sikece' target='_blank'>SiKeCe</a>
                                        </p>
                                    </center>
                                    ...
                                    <div class="footer text-center">
                                        <button type="submit"
                                            class="btn btn-warning btn-simple btn-wd btn-lg">Login</button>
                                    </div>
                                </div>
                            </form>
                        </div>
