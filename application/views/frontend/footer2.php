...
<footer class="footer py-4">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-4 text-lg-left" style="color:white">Copyright © SI <?= date('Y')?> | <a
            ...
            <div class="col-lg-4 text-lg-right">
                <a class="mr-3" href="#!"> Kontak Admin</a>
                <a href="#!">Other</a>
            </div>
        </div>
    </div>
...
$('#jenis').change(function() {
    ...
    const spkk = ['KK Lama (Asli & FC)', 'KTP', 'Surat Pindah dari daerah asal', 'FC Buku Nikah',
        'Surat Pengantar/Keterangan RT & RW'
    ]
    const spna = ['FC KK Calon Suami & Istri', 'FC KTP Calon Suami & Istri', 'Pas Foto 3x4 Calon Suami & Istri',
        'Surat Pengantar/Keterangan RT & RW', 'FC Akta Cerai (Bagi Janda/Duda)'
    ]
    ...
    const skaw = ['KTP (Asli & FC)', 'KTP (Asli & FC)', 'Surat Pengantar/Keterangan RT & RW']
