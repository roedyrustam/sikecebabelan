 ...
 <header class="masthead">
     <div class="container">
         ...
         <div class="masthead-heading text-uppercase">Kecamatan Babelan</div>
 ...
 <section class="page-section" id="profil">
     <div class="container">
         <div class="text-center">
             ...
             <h3 class="section-subheading text-muted">Kecamatan Babelan , Kabupaten Bekasi</h3>
         </div>
         ...
         <div class="row">
             <div class="col-lg-4 col-sm-6 mb-4">
                 <div class="portfolio-item">
                     <a class="portfolio-link" data-toggle="modal" href="#skecamatan">
                         <div class="portfolio-hover">
                             <div class="portfolio-hover-content"><i class="fas fa-plus fa-3x"></i></div>
                         </div>
                         <img class="img-fluid" src="<?= base_url('/assets/galery/'); echo $profil[0]['s_kecamatan'] ?>"
                             alt="struktur-kecamatan" />
                     </a>
                     <div class="portfolio-caption">
                         <div class="portfolio-caption-heading">Struktur Kecamatan Babelan </div>
             ...
             <div class="col-lg-4 col-sm-6 mb-4">
                 <div class="portfolio-item">
                     ...
                     <div class="portfolio-caption">
                         <div class="portfolio-caption-heading">Struktur Pemuda kecamatan</div>
                         <div class="portfolio-caption-subheading text-muted">Klik + lihat detail</div>
                     </div>
                 </div>
             </div>
             ...
             <div class="container">
                 <div class="text-center">
                     <h2 class="section-heading text-uppercase">SIKece Babelan</h2>
                     <h3 class="section-subheading text-muted">Kecamatan Babelan , Kabupaten
                         Bekasi
                     </h3>
                 </div>
                 <div class="row text-justify pl-5 pr-5">
                     <p>Diberitahukan untuk melakukan Pengajuan Surat Online dimohon untuk melengkapi data dengan benar
                         dan
                         berkas persyaratan untuk Pengajuan Surat Online di Upload. Jika terdapat permasalahan dalam
                         mengisi
                         form Pengajuan Surat Online dimohon kepada pengaju untuk datang langsung ke Kantor kecamatan
